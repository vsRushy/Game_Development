...
void j1Map::Draw()
{
	...
	p2List_item<MapLayer*>* layerItem = data.layers.start; // for now we just use the first layer and tileset
...
/*	ret.x = x * data.tile_width;
	...
	ret.x = data.tile_width * (x - y) * 0.5f;
	ret.y = data.tile_height * (x + y) * 0.5f;
